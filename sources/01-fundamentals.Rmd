...
have their own documentation which can be accessed using the `man` command, or,
...
Personally, I like listing files by timestamp and adding the `-t` flag, and make
